...
export const metadata:Metadata={title:'도서 목록 · 제목과 저자로 책 찾기',description:'수집한 도서의 제목, 저자, 분야와 소개를 한눈에 살펴보세요.',alternates:{canonical:'/books'},openGraph:{title:'도서 목록 | agentbook',url:'/books'}};
